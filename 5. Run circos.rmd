...
- karyotype.txt, band_labels.txt and labels.txt can be generated following this tutorial [here](link)

- links.txt can be generated following this tutorial [here](link)
